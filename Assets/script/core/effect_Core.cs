...
public class effect_Core : MonoBehaviour
{
    ...
    public void Create_effect(string path, float x, float y, Transform parent, bool world)
    {
    ...
    private void Create(string path, float x, float y, Transform parent, bool world) {
    ...
    IEnumerator Bonus_eff(GameObject obj, string sound)
    {
    ...
    IEnumerator Bonus_eff_transparen(SpriteRenderer obj)
    {
        float y = obj.transform.position.y + 2f;
        var timeStep = 0.0f;
        while (timeStep < 1.0f)
